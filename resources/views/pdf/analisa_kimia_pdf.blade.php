...
<body>
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" style="border:solid;">
        ...
        <tr>
            <td>
                {{-- table dokumen kiri --}}
                <table style="width:100%; height:90px; border:none; border-style:none; border-right-style:none; border-top-style:none; border-bottom-style:none;">
            ...
            <td>
                {{-- table tanggal kanan --}}
                <table style="width:100%; border:none; border:none; border-style:none; border-left-style:none; border-left-style:none; border-top-style:none; border-bottom-style:none;">
        ...
        <tr>
          <td colspan="2" align="center">
            ...
            <table style="width:100%; height:20px; border:none; border-style:none; border-right-style:none; border-top-style:none; border-bottom-style:none;">
                <tr style="border:none;">
                    <td style="border:none;"></td>
                </tr>
                <tr style="border:none;">
            ...
            {{-- table kop surat --}}
                <table align="right" width="60%" cellpadding="0" cellspacing="0" style=" border:none; border-style:none; border-left-style:none; border-right-style:none; border-top-style:none; border-bottom-style:none;">
                    <tr style="border-left-style: hidden; border-right-style:hidden;">
